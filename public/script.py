# Create a comprehensive backend server example for medical lab system
nodejs_server_code = '''
...
with open('medical_lab_server.js', 'w') as f:
    f.write(nodejs_server_code)

# Create package.json for dependencies
package_json = '''{
  "name": "medical-lab-management-system",
  "version": "1.0.0",
  "description": "Backend server for Medical Laboratory Management System",
  "main": "medical_lab_server.js",
  "scripts": {
    "start": "node medical_lab_server.js",
    "dev": "nodemon medical_lab_server.js"
  },
  "dependencies": {
    "express": "^4.18.2",
    "sqlite3": "^5.1.6",
  ...
  "keywords": ["medical", "laboratory", "management", "system", "lims"],
  "author": "MedLab Pro",
  "license": "MIT"
}'''
...
setup_instructions = '''# Medical Laboratory Management System - Backend Setup
...
1. Create a new directory for your backend:
   ```
   mkdir medlab-backend
   cd medlab-backend
   ```

2. Copy the medical_lab_server.js and package.json files to this directory
...
4. Create a 'public' directory and copy your frontend files there:
   ```
   mkdir public
   # Copy your HTML, CSS, and JS files to the public directory
   ```
...
2. Other computers on the same network can access the system at:
...
- Database file: `medical_lab.db` (created automatically)
- Supports automatic backups and data import/export
...
- Similar endpoints for doctors, tests, samples, reports, receipts
...
with open('BACKEND_SETUP.md', 'w') as f:
    f.write(setup_instructions)

print("✅ Backend server files created:")
print("- medical_lab_server.js (Main server file)")
print("- package.json (Dependencies)")
print("- BACKEND_SETUP.md (Setup instructions)")